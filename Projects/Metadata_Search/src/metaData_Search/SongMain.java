        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 4:	// Read from file & add to play-list
                    ...
                    songCollection.addFromFile(fname);		// call addFromFile() by passing source filename 
                    break;
                    
                case 5:	//Write play-list to file
                    System.out.println("Enter file name: ");
                    String resFile = scanner.nextLine();				// read output filename
                    songCollection.writeToFile(resFile);		// call writeToFile() by passing result filename 
                    break;
